...
struct bpred_dir_t {
  ...
  union {
    ...
    struct {
      ...
      unsigned char *l2table;	/* level-2 prediction state table1 */
    } two;
    struct {
      int l1size;   /* level-1 size, number of history regs */
      int l2size;    /* level-2 size, number of pred states */
      ...
      int *shiftregs;   /* level-1 history table */
      unsigned char *l2table; /* level-2 prediction state table1 */
      unsigned char *l2table2; /* level-2 prediction state table2 */
      unsigned char *l2table3; /* level-2 prediction state table3 */
    }gskew;
  } config;
};
...
struct bpred_t {
  ...
  struct {
    ...
    struct bpred_dir_t *gskew;    /*predictor gskew*/
...
struct bpred_update_t {
  ...
  struct {		/* predicted directions */
    ...
    unsigned int gskew  : 1;    /* Predictor Gskew*/
